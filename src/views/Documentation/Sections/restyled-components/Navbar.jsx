        ...
        <div className="bd-example">
          ...
          <Navbar className="bg-info" expand="lg">
            <Container>
              ...
              <button
                aria-controls="navbarColor07"
                aria-expanded={false}
                aria-label="Toggle navigation"
                className="navbar-toggler"
                data-target="#navbarColor07"
                data-toggle="collapse"
                id="navbarColor07"
                type="button"
              >
