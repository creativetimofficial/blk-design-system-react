...
<title>
 Quick start - Blk• Design System by Creative Tim 
</title>
</head>
<body>
<p>
...
<p>
Copy-paste the stylesheet <code className=" highlighter-rouge">
<link>
</code>
 into your <code className=" highlighter-rouge">
<head>
</code>
...
<p>
Many of our components require the use of JavaScript to function. Specifically, they require <a href="https://jquery.com">
jQuery
</a>
, <a href="https://popper.js.org/">
Popper.js
</a>
, and our own JavaScript plugins. Place the following <code className=" highlighter-rouge">
<script>
</code>
...
<p>
We use <a href="https://blog.jquery.com/2016/06/09/jquery-3-0-final-released/">
jQuery’s slim build
</a>
...
<p>
Need to use a certain plugin in your page? You can find out how to integrate them and make them work in the <a href="docs/plugins/datepicker.html">
Plugins
</a>
 dedicated page. In this way you will be sure that your website is optimized and uses only the needed resources.
</p>
<h2 id="starter-template">
Starter template
</h2>
<p>
...
<span className=" s">
"/assets/vendor/PLUGIN_FOLDER/PLUGIN_SCRIPT.js"
</span>
<span className=" nt">
></script>
</span>
...
<span className=" s">
"/assets/js/blk-design-system.js"
</span>
<span className=" nt">
></script>
</span>
...
<p>
employs a handful of important global styles and settings that you’ll need to be aware of when using it, all of which are almost exclusively geared towards the <em>
normalization
</em>
...
<h3 id="responsive-meta-tag">
Responsive meta tag
</h3>
<p>
Bootstrap is developed <em>
mobile first
</em>
, a strategy in which we optimize code for mobile devices first and then scale up components as necessary using CSS media queries. To ensure proper rendering and touch zooming for all devices, <strong>
add the responsive viewport meta tag
</strong>
 to your <code className=" highlighter-rouge">
<head>
</code>
.
</p>
...
<p>
You can see an example of this in action in the <a href="#pablo" onClick={e =>
 e.preventDefault()}>
starter template
</a>
.
