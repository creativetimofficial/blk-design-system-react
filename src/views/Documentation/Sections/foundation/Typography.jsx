...
<title>
 Typography - Blk• Design System by Creative Tim 
</title>
</head>
<body>
<p>
...
<p>
All HTML headings, <code className=" highlighter-rouge">
<h1>
</code>
 through <code className=" highlighter-rouge">
<h6>
</code>
, are available.
</p>
...
h1. Bootstrap heading<span className=" nt">
</h1>
</span>
<span className=" nt">
<h2>
</span>
h2. Bootstrap heading<span className=" nt">
</h2>
</span>
<span className=" nt">
<h3>
</span>
h3. Bootstrap heading<span className=" nt">
</h3>
</span>
<span className=" nt">
<h4>
</span>
h4. Bootstrap heading<span className=" nt">
</h4>
</span>
<span className=" nt">
<h5>
</span>
h5. Bootstrap heading<span className=" nt">
</h5>
</span>
<span className=" nt">
<h6>
</span>
h6. Bootstrap heading<span className=" nt">
</h6>
</span>
</code>
</pre>
...
<div className=" bd-example">
<span className=" h3">
 Fancy display heading <small className=" text-muted">
...
<h3>
 ...
 Fancy display heading <span className=" nt">
<small
</span>
<span className=" na">
class=
...
With faded secondary text<span className=" nt">
</small>
</span>
<span className=" nt">
</h3>
...
<h2 id="display-headings">
Display headings
</h2>
<p>
Traditional heading elements are designed to work best in the meat of your page content. When you need a heading to stand out, consider using a <strong>
display heading
</strong>
...
<p>
Make a paragraph stand out by adding <code className=" highlighter-rouge">
.lead
</code>
.
</p>
...
>
 ...
 Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Duis mollis, est non commodo luctus.<span className=" nt">
</p>
</span>
</code>
</pre>
</div>
<h2 id="inline-text-elements">
Inline text elements
</h2>
<p>
...
You can use the mark tag to <span className=" nt">
<mark>
</span>
highlight<span className=" nt">
</mark>
</span>
 text.<span className=" nt">
</p>
</span>
<span className=" nt">
<p
...
This line of text is meant to be treated as deleted text.<span className=" nt">
</del></p>
</span>
<span className=" nt">
<p
...
This line of text is meant to be treated as no longer accurate.<span className=" nt">
</s></p>
</span>
<span className=" nt">
<p
...
This line of text is meant to be treated as an addition to the document.<span className=" nt">
</ins></p>
</span>
<span className=" nt">
<p
...
This line of text will render as underlined<span className=" nt">
</u></p>
</span>
<span className=" nt">
<p
...
This line of text is meant to be treated as fine print.<span className=" nt">
</small></p>
</span>
<span className=" nt">
<p
...
This line rendered as bold text.<span className=" nt">
</strong></p>
</span>
<span className=" nt">
<p
...
This line rendered as italicized text.<span className=" nt">
</em></p>
</span>
</code>
</pre>
...
.small
 ...
 classes are also available to apply the same styles as <code className=" highlighter-rouge">
<mark>
</code>
 and <code className=" highlighter-rouge">
<small>
...
<p>
While not shown above, feel free to use <code className=" highlighter-rouge">
<b>
</code>
 and <code className=" highlighter-rouge">
<i>
</code>
 in HTML5. <code className=" highlighter-rouge">
<b>
</code>
 is meant to highlight words or phrases without conveying additional importance while <code className=" highlighter-rouge">
<i>
</code>
 is mostly for voice, technical terms, etc.
</p>
<h2 id="text-utilities">
Text utilities
</h2>
<p>
Change text alignment, transform, style, weight, and color with our <a href="/docs/1.0/utilities/text/">
text utilities
</a>
 and <a href="/docs/1.0/utilities/colors/">
color utilities
</a>
.
</p>
...
<p>
Stylized implementation of HTML’s <code className=" highlighter-rouge">
<abbr>
</code>
...
<p>
For quoting blocks of content from another source within your document. Wrap <code className=" highlighter-rouge">
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.<span className=" nt">
</p>
</span>
<span className=" nt">
</blockquote>
...
<footer className="blockquote-footer">
 ...
 for identifying the source. Wrap the name of the source work in <code className=" highlighter-rouge">
<cite>
</code>
.
</p>
...
Someone famous in <span className=" nt">
<cite
</span>
<span className=" na">
title=
...
Source Title<span className=" nt">
</cite></footer>
</span>
<span className=" nt">
</blockquote>
...
<p>
Remove the default <code className=" highlighter-rouge">
list-style
</code>
 and left margin on list items (immediate children only). <strong>
...
<li className=" text-muted">
Nulla volutpat aliquam velit <ul>
<li className=" text-muted">
...
Lorem ipsum dolor sit amet<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Consectetur adipiscing elit<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Integer molestie lorem at massa<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Facilisis in pretium nisl aliquet<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Nulla volutpat aliquam velit <span className=" nt">
<ul>
</span>
<span className=" nt">
<li
...
Phasellus iaculis neque<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Purus sodales ultricies<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Vestibulum laoreet porttitor sem<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Ac tristique libero volutpat at<span className=" nt">
</li>
</span>
<span className=" nt">
</ul>
...
Faucibus porta lacus fringilla vel<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Aenean sit amet erat nunc<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Eget porttitor lorem<span className=" nt">
</li>
</span>
<span className=" nt">
</ul>
...
<p>
Remove a list’s bullets and apply some light <code className=" highlighter-rouge">
margin
</code>
 with a combination of two classes, <code className=" highlighter-rouge">
.list-inline
</code>
 and <code className=" highlighter-rouge">
.list-inline-item
...
Phasellus iaculis<span className=" nt">
</li>
</span>
<span className=" nt">
<li
...
Nulla volutpat<span className=" nt">
</li>
</span>
<span className=" nt">
</ul>
...
<h3 id="description-list-alignment">
Description list alignment
</h3>
<p>
Align terms and descriptions horizontally by using our grid system’s predefined classes (or semantic mixins). For longer terms, you can optionally add a <code className=" highlighter-rouge">
.text-truncate
</code>
...
Description lists<span className=" nt">
</dt>
</span>
<span className=" nt">
<dd
...
A description list is perfect for defining terms.<span className=" nt">
</dd>
</span>
<span className=" nt">
<dt
...
Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.<span className=" nt">
</p>
</span>
<span className=" nt">
<p
...
Donec id elit non mi porta gravida at eget metus.<span className=" nt">
</p>
</span>
<span className=" nt">
</dd>
...
Malesuada porta<span className=" nt">
</dt>
</span>
<span className=" nt">
<dd
...
Etiam porta sem malesuada magna mollis euismod.<span className=" nt">
</dd>
</span>
<span className=" nt">
<dt
...
Truncated term is truncated<span className=" nt">
</dt>
</span>
<span className=" nt">
<dd
...
Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.<span className=" nt">
</dd>
</span>
<span className=" nt">
<dt
...
Nested definition list<span className=" nt">
</dt>
</span>
<span className=" nt">
<dd
...
Aenean posuere, tortor sed cursus feugiat, nunc augue blandit nunc.<span className=" nt">
</dd>
</span>
<span className=" nt">
</dl>
...
Responsive typography
 ...
 refers to scaling text and components by simply adjusting the root element’s <code className=" highlighter-rouge">
font-size
</code>
 within a series of media queries. Bootstrap doesn’t do this for you, but it’s fairly easy to add if you need it.
</p>
<p>
Here’s an example of it in practice. Choose whatever <code className=" highlighter-rouge">
font-size
</code>
