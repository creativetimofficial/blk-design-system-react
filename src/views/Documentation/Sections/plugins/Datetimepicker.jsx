...
<title>
 DateTimePicker v4.17.47 - Blk• Design System by Creative Tim 
</title>
</head>
<body>
<p>
...
<p>
We have created the design of the date-time picker made by <strong>
<a href="https://github.com/Eonasdan" rel="noopener noreferrer" target="_blank">
Eonasdan
</a>
</strong>
. We have changed the colors, typography and buttons, so it can look like the rest of the dashboard.
</p>
<p>
For more information please check <strong>
<a href="https://eonasdan.github.io/bootstrap-datetimepicker/" rel="noopener noreferrer" target="_blank">
...
<ReactDatetime inputProps={{ className: "form-control", placeholder: "Date Picker Here" }} timeFormat={false}>
</ReactDatetime>
</FormGroup>
</div>
...
Datetime Picker<span className="nt">
</label>
</span>
<span className="nt">
<input
...
$('.datetimepicker').datetimepicker({ icons: { time: "fa fa-clock-o", date: "fa fa-calendar", up: "fa fa-chevron-up", down: "fa fa-chevron-down", previous: 'fa fa-chevron-left', next: 'fa fa-chevron-right', today: 'fa fa-screenshot', clear: 'fa fa-trash', close: 'fa fa-remove' }});
</code>
</pre>
</figure>
</Col>
