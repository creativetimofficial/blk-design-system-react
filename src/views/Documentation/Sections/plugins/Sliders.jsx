...
<title>
 Sliders v11.1.0 - Blk• Design System by Creative Tim 
</title>
</head>
<body>
<p>
...
<p>
We restyled noUIslider, while keeping the design consistent. You can use other classes for colors like <code className=" highlighter-rouge">
.slider-info
</code>
...
<a href="https://refreshless.com/nouislider/" rel="noopener noreferrer" target="_blank">
...
var slider = document.getElementById('sliderRegular');noUiSlider.create(slider, {start: 40,connect: [true,false],range: {min: 0,max: 100}});var slider2 = document.getElementById('sliderDouble');noUiSlider.create(slider2, {start: [ 20, 60 ],connect: true,range: {min: 0,max: 100}});
</code>
</pre>
</figure>
</Col>
